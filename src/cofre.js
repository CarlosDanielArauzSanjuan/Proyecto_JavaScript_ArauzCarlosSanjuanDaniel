...
export function inicializarCofre() {
  ...
  // Función para agregar un ítem al cofre
  function agregarItemAlCofre(contenedor, tipo, index, titulo) {
    ...
    let imagenSrc = "./assets/img/equipamiento/default.png"
  
    // Intentamos cargar imágenes específicas si existen
    try {
      switch (tipo) {
        case "armor":
          imagenSrc = `./assets/img/equipamiento/armor/${index}.png`
          break
        case "weapon":
          imagenSrc = `./assets/img/equipamiento/weapons/${index}.png`
          break
        case "spell":
          imagenSrc = `./assets/img/equipamiento/spells/${index}.png`
          break
        case "gear":
          imagenSrc = `./assets/img/equipamiento/gear/${index}.png`
          break
      }
    } catch (error) {
    ...
    item.innerHTML = `
     <div class="cofre-item-imagen">
       <img src="${imagenSrc}" alt="${index}" 
            onerror="this.onerror=null; this.src='./assets/img/equipamiento/default.png'; 
